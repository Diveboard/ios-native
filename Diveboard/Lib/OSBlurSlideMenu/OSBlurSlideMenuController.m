...
- (void)viewDidLoad
{
    ...
    self.blurView = [[UIView alloc] initWithFrame:[self frameForBlurView]];
    
    [self.blurView setBackgroundColor:[UIColor colorWithWhite:0.0 alpha:0.5]];
...
-(void)viewWillLayoutSubviews{
    ...
    [self.blurView setFrame:[self frameForBlurView]];
}
